...
import numpy as np
from keras import ops, layers, activations, random, initializers, Variable
...
class patch_merging(layers.Layer):
    ...
    def __init__(self, num_patch, embed_dim, name="", **kwargs):
        ...
        self.linear_trans = layers.Dense(
...
class patch_expanding(layers.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.linear_trans1 = layers.Conv2D(
        ...
        #
        self.linear_trans2 = layers.Conv2D(
            upsample_rate * embed_dim,
            kernel_size=1,
            use_bias=False,
            name="{}_linear_trans1".format(name),
...
class WindowAttention(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.relative_position_index = Variable(
            initial_value=ops.convert_to_tensor(relative_position_index),
            trainable=False,
    ...
    def call(self, x, mask=None):
        ...
        # layers.Dropout after attention
        ...
        # layers.Dropout after projection
